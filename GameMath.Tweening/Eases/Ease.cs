...
namespace GameMath.Tweening
{
    abstract class Ease
    {
        ...
        public abstract Vectors.Vector2D Interpolate2D(Quadratic interpolation, Tween tween, double currentDuration);
        public abstract Vectors.Vector2D Interpolate2D(Cubic interpolation, Tween tween, double currentDuration);
        public abstract Vectors.Vector2D Interpolate2D(Elastic interpolation, Tween tween, double currentDuration);
    }
}
