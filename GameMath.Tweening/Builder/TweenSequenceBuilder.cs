...
{
    public static ITweenSequenceFor<short, decimal> Add(short value) => new Tween<short>().Add(value);
    public static ITweenSequenceFor<int, decimal> Add(int value) => new Tween<int>().Add(value);
    public static ITweenSequenceFor<long, decimal> Add(long value) => new Tween<long>().Add(value);
    public static ITweenSequenceFor<float, decimal> Add(float value) => new Tween<float>().Add(value);
    public static ITweenSequenceFor<double, decimal> Add(double value) => new Tween<double>().Add(value);
    public static ITweenSequenceFor<decimal, decimal> Add(decimal value) => new Tween<decimal>().Add(value);

    public static ITweenSequence2DFor<short, Point2D<decimal>> Add(Point2D<short> value) => new Tween2D<short>().Add(value);
    public static ITweenSequence2DFor<int, Point2D<decimal>> Add(Point2D<int> value) => new Tween2D<int>().Add(value);
    public static ITweenSequence2DFor<int, Point2D<decimal>> Add(System.Drawing.Point value) => new Tween2D<int>().Add(value);
    public static ITweenSequence2DFor<int, Point2D<decimal>> Add(Microsoft.Xna.Framework.Point value) => new Tween2D<int>().Add(value);
    public static ITweenSequence2DFor<long, Point2D<decimal>> Add(Point2D<long> value) => new Tween2D<long>().Add(value);
    public static ITweenSequence2DFor<float, Point2D<decimal>> Add(Point2D<float> value) => new Tween2D<float>().Add(value);
    public static ITweenSequence2DFor<float, Point2D<decimal>> Add(System.Drawing.PointF value) => new Tween2D<float>().Add(value);
    public static ITweenSequence2DFor<double, Point2D<decimal>> Add(Point2D<double> value) => new Tween2D<double>().Add(value);
    public static ITweenSequence2DFor<decimal, Point2D<decimal>> Add(Point2D<decimal> value) => new Tween2D<decimal>().Add(value);

    public static ITweenSequence3DFor<short, Point3D<decimal>> Add(Point3D<short> value) => new Tween3D<short>().Add(value);
    public static ITweenSequence3DFor<int, Point3D<decimal>> Add(Point3D<int> value) => new Tween3D<int>().Add(value);
    public static ITweenSequence3DFor<long, Point3D<decimal>> Add(Point3D<long> value) => new Tween3D<long>().Add(value);
    public static ITweenSequence3DFor<float, Point3D<decimal>> Add(Point3D<float> value) => new Tween3D<float>().Add(value);
    public static ITweenSequence3DFor<double, Point3D<decimal>> Add(Point3D<double> value) => new Tween3D<double>().Add(value);
    public static ITweenSequence3DFor<decimal, Point3D<decimal>> Add(Point3D<decimal> value) => new Tween3D<decimal>().Add(value);
